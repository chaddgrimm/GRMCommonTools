#
# Be sure to run `pod lib lint GRMCommonTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'GRMCommonTools'
  s.version          = '0.1.4'
  s.summary          = 'Helpful toolset for your iOS development needs.'
...
This pod is a collection of helpful classes/methods based on other opensource frameworks.
  ...
  s.source_files = 'GRMCommonTools/**/*'
  
  # s.resource_bundles = {
  #   'GRMCommonTools' => ['GRMCommonTools/Assets/*.png']
  # }
